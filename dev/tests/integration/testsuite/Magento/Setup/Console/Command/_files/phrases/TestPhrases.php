...
class TestPhrases
{
    public function awesomeFunction()
    {
        ...
        $simpleCases = [
            ...
            new Phrase('simple text with 1 variables placeholder %1', $str1),
        ...
        $phraseObjects = [
            ...
            new Phrase('first part of concat' . ' second part with one variables placeholder %1', $str1),
        ...
        $singleQuoteTranslateFunctions = [
            ...
            __('first part of concat' . ' second part with one variables placeholder %1', $str1),
