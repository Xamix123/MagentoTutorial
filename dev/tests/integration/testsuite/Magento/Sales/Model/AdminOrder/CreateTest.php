...
class CreateTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetCustomerWishlist()
    {
        ...
        self::assertSame(
            ...
            'Wish List cached in class variables is expected to be returned.'
        );
        self::assertNotSame(
            $updatedWishlist,
            $this->model->getCustomerWishlist(true),
    ...
    public function testSetBillingAddressValidationErrors()
    {
        ...
        /**
         * Note that validation errors are collected during setBillingAddress() call in the internal class variables,
