...
class TemplateTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testTemplateLoadedFromDbIsFilteredInStrictMode()
    {
        ...
        // The first variables should be processed because it didn't come from the DB
    ...
    /**
     * Ensure that the template_styles variables contains styles from either <!--@styles @--> or the "Template Styles"
