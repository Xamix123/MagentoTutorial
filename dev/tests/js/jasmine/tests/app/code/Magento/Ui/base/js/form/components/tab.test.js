...
define([
    ...
    describe('Magento_Ui/js/form/components/tab', function () {
        ...
        describe('"activate" method', function () {
            ...
            it('Check observable variables "active" after execution activate method', function () {
                obj.activate();
                expect(obj.active()).toEqual(true);
            });
            it('Check observable variables "wasActivated" after execution activate method', function () {
                obj.activate();
