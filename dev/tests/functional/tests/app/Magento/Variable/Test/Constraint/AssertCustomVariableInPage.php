...
/**
 * Add created variables to page and assert that Custom Variable is displayed on frontend page.
 */
class AssertCustomVariableInPage extends AbstractConstraint
{
    /**
     * Add created variables to page and assert that Custom Variable is displayed on frontend page and has
