...
/**
 * Check that created custom variables is displayed on backend in custom variables grid and has correct data
...
class AssertCustomVariableInGrid extends AbstractConstraint
{
    ...
    /**
     * Assert custom variables is displayed on backend in custom variables grid.
     *
