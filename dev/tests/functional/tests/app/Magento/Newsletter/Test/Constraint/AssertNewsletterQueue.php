 ...
 * Assert that "Menu Queue" page opened and subject, sender name, sender email and template content correct
 */
class AssertNewsletterQueue extends AbstractAssertForm
{
    ...
    {
        return 'Menu Queue content equals to passed from fixture.';
    }
}
