...
(function ($) {
	var themes_loaded = [];
	// this variables stores the path to the themes folder - if left as false - it will be autodetected
...
(function ($) {
	...
	var xsl = {
		'nest' : '<' + '?xml version="1.0" encoding="utf-8" ?>' +
			...
			'		<xsl:variables name="children" select="count(./item) &gt; 0" />' +
			'		<li>' +
		...
		'flat' : '<' + '?xml version="1.0" encoding="utf-8" ?>' +
			...
			'	<xsl:variables name="children" select="count(//item[@parent_id=$node/attribute::id]) &gt; 0" />' +
			'	<li>' +
			'	<xsl:attribute name="class">' +
