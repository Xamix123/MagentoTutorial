...
define([
    ...
    proto.noSelect = function() {
        ...
        // Since the string 'none' is used three times, storing it in a variables gives better results after minification
        var none = 'none';
    ...
    if (isDetailsSupported) {
        ...
        details = proto.details = function() {
            ...
            return this.each(function() {
                ...
                // Store a reference to the current `details` element in a variables
                var $details = $(this),
                    // Store a reference to the `summary` element of the current `details` element (if any) in a variables
